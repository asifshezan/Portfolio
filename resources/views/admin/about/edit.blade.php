        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">Update About Details</li>
                </ol>
            </div>
    ...
    <div class="col-md-12">
        <div class="card border border-primary">
            <div class="card-header bg-transparent border-primary d-flex justify-content-between">
                <h5 class="my-0 text-primary align-middle"><i class="mdi mdi-bullseye-arrow me-3"></i>Update About </h5>
            ...
            <div class="card-body">
                <div class="card-body">
                    <form action="{{ route('about.update',$data->ab_id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row form-group">
                            <div class="col-md-6 my-2">
                                <label for="ab_title">Title</label>
                                <input type="hidden" class="ab_id" value={{ $data['ab_id']}}>
