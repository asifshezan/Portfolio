    ...
    <div class="col-md-12">
        <div class="card border border-primary">
            <div class="card-header bg-transparent border-primary d-flex justify-content-between">
                <h5 class="my-0 text-primary align-middle"><i class="mdi mdi-bullseye-arrow me-3"></i>Edit experience </h5>
                <a href="{{ route('experience.index') }}" class="btn btn-sm btn-primary waves-effect waves-light">
                    <i class="bx bx-list-plus font-size-20 align-middle me-2"></i> All experience
                </a>
            </div>
            <div class="card-body">
                <div class="card-body">
                    <form action="{{ route('experience.update',$data->exp_slug) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="col-md-6 my-2">
                            ...
                            <input class="form-control" type="text" name="exp_text" value="{{ $data->exp_text }}">
                            @error('exp_text')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-md-6 my-2">
                            ...
                            <input class="form-control" type="text" name="exp_year" value="{{ $data->exp_year }}">
                            @error('exp_year')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-md-7 mt-4">
                            <button type="submit" class="btn btn-primary waves-effect waves-light">
                                <i class="bx bxs-save font-size-16 align-middle me-2"></i> Experience Updata
                            </button>
                        </div>
                    </div>
                </form>
