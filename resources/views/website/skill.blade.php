                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-6 pb_col">
                            <div class="pb_item">
                                <div class="p_bar_title">Developement</div>
                                <div id="skill_2_pbar" class="skill_barss" data-perc="0.60" data-name="skill_2_pbar" data-color-start="#ff4646" data-color-end="#ff26d9"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4 col-lg-6 pb_col">
                            <div class="pb_item">
                                <div class="p_bar_title">Developement</div>
                                <div id="skill_3_pbar" class="skill_barss" data-perc="0.75" data-name="skill_3_pbar" data-color-start="#0054ff" data-color-end="#ff23d3"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4 col-lg-6 pb_col">
                            <div class="pb_item">
                                <div class="p_bar_title">Developement</div>
                                <div id="skill_4_pbar" class="skill_barss" data-perc="1.0" data-name="skill_4_pbar" data-color-start="#79ff7c" data-color-end="#ffbd4a"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4 col-lg-6 pb_col">
                            <div class="pb_item">
                                <div class="p_bar_title">Developement</div>
                                <div id="skill_5_pbar" class="skill_barss" data-perc="0.90" data-name="skill_5_pbar" data-color-start="#79ff8f" data-color-end="#7b74ff"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4 col-lg-6 pb_col">
                            <div class="pb_item">
                                <div class="p_bar_title">Developement</div>
                                <div id="skill_6_pbar" class="skill_barss" data-perc="1.0" data-name="skill_6_pbar" data-color-start="#ff2d72" data-color-end="#ffab79"></div>
                            </div>
                        </div>
